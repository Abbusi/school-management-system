...
class Employee extends Model
{
    ...
    {
        return $this->hasMany('App\Models\IClass', 'teacher_id');
    }

    public function section()
    {
        return $this->hasMany('App\Models\Section', 'teacher_id');
    }
    ...
    public function attendance()
    {
        ...
        return $this->hasMany('App\Models\EmployeeAttendance', 'employee_id');
    }
