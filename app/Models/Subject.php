...
class Subject extends Model
{
    ...
    {
        return $this->belongsToMany('App\Models\Employee','teacher_subjects', 'subject_id', 'teacher_id')
    ...
    {
        return $this->hasMany('App\Models\Mark', 'subject_id');
    }
    ...
    {
        return $this->belongsToMany('App\Models\Registration','student_subjects', 'subject_id', 'registration_id');
    }
